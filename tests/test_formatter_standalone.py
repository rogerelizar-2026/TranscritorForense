"""
Testes Unitários - Módulo ForensicFormatter (standalone)
Não requer dependências externas além de jinja2 e pyyaml
"""
...
# Importa apenas o formatter que não depende de pyannote/whisperx/speechbrain
